...
class Program
{
    ...
    static void RegisterStudent(string file) // the string variable file is use for connecting to EnrollSubject  
    {
        ...
        string json = JsonSerializer.Serialize(students, new JsonSerializerOptions { WriteIndented = true });// And this file will be use to connect in RegisterStudent
        {
    ...
    static void ShowGrades(string grad) //  The string is use to connect to enter grades
    {
       ...
       else 
        {
            ...
            Console.WriteLine("No grade file found."); // this is use to indicate that the grade no yet made
        }
    }
